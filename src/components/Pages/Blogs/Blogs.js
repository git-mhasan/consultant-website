...
const Blogs = () => {
    return (
        <div className='container my-5 mx-auto px-5'>
            <h6><span>Question-1: </span>Difference between authorization and authentication.</h6>
            ...
            <h6><span style={{ fontWeight: "700" }}>Question-2: </span>Why are you using firebase ? What other options do you have to implement authentication ?</h6>
            <p><span style={{ fontWeight: "700" }}>Answer:</span> We mainly used firebase for authentication purpose. We also used firebase hosting service. In addition to that firebase offer many services, such as firestore database, realtime databade, cloud storage etc.
                ...
                4. Keycloak<br />
                5. Passport etc.</p>
            <h6><span style={{ fontWeight: "700" }}>Question-3: </span>What other services does firebase provide other than authentication.</h6>
